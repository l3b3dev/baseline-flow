...
for runs in range(total_runs):
    ...
    #
    #     if dataset == 'flow_cylinder':
    #         plot_flow_cyliner_2(output_temp.cpu().data.numpy()[390, :, :].reshape(n, m), n, m, Xmean)
    #         #plot error
...
if plotting == True:
    ...
    plot_dominant_modes(sensors, Xsmall, sensors_test, Xsmall_test,
                  n_snapshots_train, n_snapshots_test,
                  model, Xmean, sensor_locations, n,m)
